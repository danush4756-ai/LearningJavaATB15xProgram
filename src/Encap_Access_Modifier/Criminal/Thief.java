...
/*crime.CanIShoot(); protected cannot be accessed from different package unless it is subclass through
inheritance*/
//crime.IdCard = "Check"; private accessed outside the package
       // crime.UnderstandingDefault(); defaut cannot be accessed outside the package
    }
    }
